...
const uygulamalar: Uygulama[] = [
    {
        id: 'nginx',
        ad: 'Nginx',
        aciklama: 'Yüksek performanslı web sunucusu ve reverse proxy',
        imaj: 'nginx:alpine',
        kategori: 'Web',
        puan: 5,
        portlar: ['80:80', '443:443']
    },
    {
        id: 'portainer',
        ad: 'Portainer',
        aciklama: 'Docker ve Kubernetes için görsel yönetim arayüzü',
    ...
    },
    {
        id: 'filebrowser',
        ad: 'Dosya Gezgini',
        aciklama: 'Web tabanlı dosya yöneticisi',
        imaj: 'filebrowser/filebrowser:latest',
        kategori: 'Dosya',
        puan: 4,
        portlar: ['8080:80']
    },
    {
        id: 'nextcloud',
        ad: 'Nextcloud',
        aciklama: 'Kendi bulut depolama ve işbirliği platformunuz',
    ...
    },
    {
        id: 'heimdall',
        ad: 'Heimdall',
        aciklama: 'Uygulama kontrol paneli ve başlatıcı',
        imaj: 'linuxserver/heimdall:latest',
        kategori: 'Yönetim',
        puan: 4,
        portlar: ['8082:80']
    },
    {
        id: 'plex',
        ad: 'Plex',
        aciklama: 'Medya sunucusu - Film, dizi ve müzik akışı',
        imaj: 'plexinc/pms-docker:latest',
        kategori: 'Medya',
        puan: 5,
        portlar: ['32400:32400']
    },
    {
        id: 'pihole',
        ad: 'Pi-hole',
        aciklama: 'Ağ düzeyinde reklam engelleme',
        imaj: 'pihole/pihole:latest',
        kategori: 'Ağ',
        puan: 5,
        portlar: ['53:53', '8083:80']
    },
    {
        id: 'homeassistant',
        ad: 'Home Assistant',
        aciklama: 'Açık kaynaklı akıllı ev otomasyonu',
        imaj: 'homeassistant/home-assistant:stable',
        kategori: 'Akıllı Ev',
        puan: 5,
        portlar: ['8123:8123']
    }
...
export default function UygulamaMagazasi() {
    ...
    const filtrelenmisUygulamalar = uygulamalar.filter(uygulama => {
        const aramaEslesiyor = uygulama.ad.toLowerCase().includes(arama.toLowerCase()) ||
            uygulama.aciklama.toLowerCase().includes(arama.toLowerCase());
    ...
    const uygulamaKur = async (uygulama: Uygulama) => {
        ...
        try {
            ...
            setMesaj({ tip: 'basari', metin: `${uygulama.ad} başarıyla indirildi! Konteyner oluşturmak için Docker CLI kullanın.` });
        } catch (hata: any) {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            {/* Başlık */}
            <div>
                <h1 className="text-3xl font-bold text-white">Uygulama Mağazası</h1>
                <p className="text-gray-400 mt-1">Popüler uygulamaları tek tıkla kurun</p>
            </div>

            {mesaj && (
                <div className={`px-4 py-3 rounded-xl text-sm ${mesaj.tip === 'basari'
                ...
                <div className="flex flex-wrap gap-2">
                    {kategoriler.map((kategori) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl transition-colors ${seciliKategori === kategori
                    ...
                    <div key={uygulama.id} className="glass-card rounded-2xl p-6 flex flex-col">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm text-gray-400">{uygulama.puan}</span>
                            </div>
                        </div>
                        ...
                        <button
                            onClick={() => uygulamaKur(uygulama)}
                            disabled={kuruluyor === uygulama.id}
...
// Geriye uyumluluk
export { UygulamaMagazasi as AppStore };
